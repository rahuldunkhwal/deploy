...
const PropertyModal = ({ details }: PropertyModalProps) => {
  return (
      ...
      <div className="max-w-5xl w-full bg-white rounded-3xl p-3 overflow-hidden flex flex-row relative">
        ...
        <div className="md:w-3/5 p-6">
          ...
          <div className="mb-6">
            ...
            <Typography variant="heading1" className="text-2xl font-extralight">
              {details.price}
            </Typography>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <Button
              className="bg-white text-black px-6 py-2 rounded-full border border-black"
              variant="cardDetails"
            >
              Download Catalog
            </Button>
